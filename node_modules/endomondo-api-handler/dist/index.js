...
var CookieApi = _interopDefault(require('cookie-api-handler'));
...
var index = ({
    ...
    EndomondoAuthException: EndomondoAuthException
});
...
class Api extends CookieApi {
  constructor(csfrtoken = '123456789') {
    super(ENDOMONDO_URL, [new restApiHandler.DefaultResponseProcessor(EndomondoApiException)]);
...
var index$1 = ({
    ...
    rewriteCadenceData: rewriteCadenceData
});
